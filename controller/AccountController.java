...
public class AccountController {
    ...
    public String createAccount(Scanner sc) {
        ...
        return accSer.createAccount(new AccountBuilder()
    ...
    public String deposit(Scanner sc) {
        ...
        return accSer.deposit(new AccountBuilder()
                .transactionDate(nowDate)
    ...
    public String getBalance(Scanner sc) {
        ...
        return accSer.getBalance(new AccountBuilder()
                .accountNumber(sc.next())
                .transactionDate(nowDate)
                .build());
    }
    ...
    public String cancelAccount(Scanner sc) {
        ...
        System.out.println("Please enter the Account & holder.");
        return accSer.cancelAccount(new AccountBuilder()
                .accountNumber(sc.next())
                .accountHolder(sc.next())
                .transactionDate(nowDate)
                .build());
